defmodule Recollect.AlbumControllerTest do
  use Recollect.ConnCase
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    album = Repo.get_by!(Album, @valid_attrs)
    assert redirected_to(conn) == album_path(conn, :show, album.id)
  end
